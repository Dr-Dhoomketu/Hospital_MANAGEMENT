...
function FloatingCard({ icon, label, rotate, top, right, bottom, delay, g1, g2, iconG }: {
  ...
  return (
    <div style={{
      position: 'absolute', top, right, bottom,
      width: '180px', height: '210px', borderRadius: '24px',
      background: `linear-gradient(145deg, ${g1}, ${g2})`,
      boxShadow: '0 32px 72px rgba(10,31,68,0.4), inset 0 1px 0 rgba(255,255,255,0.1)',
      ...
      <span style={{ fontSize: '0.55rem', fontWeight: 800, letterSpacing: '0.2em', color: 'rgba(255,255,255,0.45)', textTransform: 'uppercase' }}>{label}</span>
    </div>
  );
}
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: '420px', position: 'relative', zIndex: 10 }}>
          ...
          <div style={{ marginBottom: '36px' }}>
            <div style={{ fontSize: '0.58rem', fontWeight: 800, letterSpacing: '0.3em', textTransform: 'uppercase', color: '#2F5DAA', marginBottom: '10px' }}>Patient Portal</div>
            <h1 style={{ fontSize: '2.2rem', fontWeight: 900, color: '#0A1F44', letterSpacing: '-0.04em', lineHeight: 1.05, marginBottom: '8px' }}>Welcome back</h1>
